...
export declare type PluginLinkResolver = (input: {
    key?: string;
    value?: unknown;
    node: PrismicDocument;
}) => LinkResolver;
export declare type HTMLSerializer = typeof PrismicDOM.HTMLSerializer;
export declare type PluginHTMLSerializer = (input: {
    key: string;
    value: unknown;
    node: PrismicDocument;
}) => HTMLSerializer;
...
export declare type BrowserPluginOptions = GatsbyPluginOptions & Pick<PluginOptions, 'repositoryName' | 'accessToken' | 'fetchLinks' | 'schemas' | 'lang' | 'typePathsFilenamePrefix' | 'prismicToolbar'>;
