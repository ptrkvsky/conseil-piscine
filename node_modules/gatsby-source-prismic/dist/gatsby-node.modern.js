...
`),String(ee).replace("\n"," "));var ee;const te=async(a,n)=>{const{actions:r,reporter:s,store:o,schema:c,cache:l}=a,{createTypes:m}=r,{program:d}=o.getState(),u=s.activityTimer($("create types")),h=s.activityTimer($("fetch documents")),g=s.activityTimer($("create nodes")),y=s.activityTimer($("write out type paths"));try{n=(e=>{const t=p(e,L);return f(t,L),t})(n)}catch(e){s.error($("invalid plugin options")),s.panic(e)}u.start(),s.verbose($("starting to create types"));const{typeDefs:T,typePaths:I}=((e,t)=>{const{schema:i}=t,a=[],n=e=>{a.push(e)},r=[],s={gatsbyContext:t,enqueueTypeDef:n,enqueueTypePath:(e,t)=>{r.push({path:e,type:t})}};for(const t in e)C(t,e[t],{...s,customTypeApiId:t});return n(i.buildUnionType({name:R.AllDocumentTypes,types:Object.keys(e).map(e=>E(e))})),n(((e,t)=>{const i=e.filter(e=>e.type===R.ImageThumbnail).map(e=>e.path[e.path.length-1]);if(i.length<1)return t.buildScalarType({name:R.ImageThumbnails,serialize:()=>null});const a=i.reduce((e,t)=>(e[t]=R.ImageThumbnail,e),{});return t.buildObjectType({name:R.ImageThumbnails,fields:a})})(r,i)),{typeDefs:a,typePaths:r}})(n.schemas,a),[S,v]=(({schema:e,cache:t,defaultImgixParams:i,defaultPlaceholderImgixParams:a})=>{const n=e=>e.url,r=e=>{var t;return null===(t=e.dimensions)||void 0===t?void 0:t.width},s=e=>{var t;return null===(t=e.dimensions)||void 0===t?void 0:t.height},o=D({name:"PrismicImageFixedType",cache:t}),c=x({name:"PrismicImageFluidType",cache:t});return[[o,c],[e.buildObjectType({name:"PrismicImageType",description:"An image field with optional constrained thumbnails.",interfaces:["PrismicImageInterface"],fields:{alt:"String",copyright:"String",dimensions:"PrismicImageDimensionsType",url:k({resolveUrl:n,defaultImgixParams:i}),fixed:N({type:o,resolveUrl:n,resolveWidth:r,resolveHeight:s,cache:t,defaultImgixParams:i,defaultPlaceholderImgixParams:a}),fluid:F({type:c,resolveUrl:n,resolveWidth:r,resolveHeight:s,cache:t,defaultImgixParams:i,defaultPlaceholderImgixParams:a}),localFile:{type:"File",extensions:{link:{}}},thumbnails:"PrismicImageThumbnailsType"}}),e.buildObjectType({name:"PrismicImageThumbnailType",description:"An image thumbnail with constraints.",interfaces:["PrismicImageInterface"],fields:{alt:"String",copyright:"String",dimensions:"PrismicImageDimensionsType",url:k({resolveUrl:n,defaultImgixParams:i}),fixed:N({type:o,resolveUrl:n,resolveWidth:r,resolveHeight:s,cache:t,defaultImgixParams:i}),fluid:F({type:c,resolveUrl:n,resolveWidth:r,resolveHeight:s,cache:t,defaultImgixParams:i}),localFile:{type:"File",extensions:{link:{}}}}})]]})({schema:c,cache:l,defaultImgixParams:n.imageImgixParams,defaultPlaceholderImgixParams:n.imagePlaceholderImgixParams});m(T),m(S),m(v),m(V),u.end(),h.start(),s.verbose($("starting to fetch documents"));const P=await(async(e,t)=>{const{repositoryName:i,releaseID:a,accessToken:n,fetchLinks:r,lang:s}=e,{reporter:o}=t,c=await(async(e,t)=>await b(`https://${e}.prismic.io/api/v2`,{accessToken:t}))(i,n),l={};if(a){const e=c.refs.find(e=>e.id===a);e?l.ref=e.ref:o.warn($(`A release with ID "${a}" was not found. Defaulting to the master ref instead.`))}return r&&(l.fetchLinks=r),s&&(l.lang=s),await q(c,l,1,100,[],o)})(n,a);s.verbose($(`fetched ${P.length} documents`)),h.end(),g.start(),s.verbose($("starting to create nodes"));const w=((e,t,i)=>{const{actions:a,createNodeId:n,createContentDigest:r}=t,{createNode:s}=a;return{createNode:s,createNodeId:e=>n(e),createContentDigest:r,normalizeImageField:Y,normalizeLinkField:Z,normalizeSlicesField:X,normalizeStructuredTextField:K,typePaths:i,pluginOptions:e,context:{gatsbyContext:t}}})(n,a,I);await(async(e,t)=>await Promise.all(e.map(e=>(async(e,t)=>{const{createNode:i,createContentDigest:a,createNodeId:n,pluginOptions:r}=t,{linkResolver:s}=r;let o=void 0;s&&(o=s({node:e}));const c=n(`${e.type} ${e.id}`),l=o?o(e):void 0,m=await H(e.data,[e.type,"data"],e,t),d=await B("alternate_languages",e.alternate_languages,[e.type],e,t),u={...e,id:c,prismicId:e.id,data:m,dataString:JSON.stringify(e.data),dataRaw:e.data,alternate_languages:d,url:l,internal:{type:E(e.type),contentDigest:a(e)},_previewable:e.id};return i(u),u.id})(e,t))))(P,w),g.end(),y.start(),s.verbose($("starting to write out type paths"));const _=i(JSON.stringify(n.schemas)),A=t.resolve(d.directory,"public",[n.typePathsFilenamePrefix,_,".json"].filter(e=>null!=e).join(""));s.verbose($("writing out type paths to : "+A)),e.writeFileSync(A,JSON.stringify(I)),y.end()},ie=i=>{const{store:a}=i,{program:n}=a.getState();e.copyFileSync(t.resolve(__dirname,"../fragments.js"),t.resolve(n.directory,".cache/fragments/gatsby-source-prismic-fragments.js"))};export{ie as onPreExtractQueries,te as sourceNodes};
